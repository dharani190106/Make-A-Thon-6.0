...
export default function ElectronicsPage() {
  ...
  const hardwareProblems = [
    {
      id: 16,
      title: "Portable EMI/EMC, Induction Measurement Instruments",
      description:
        "Design and develop portable instruments capable of accurately measuring Electromagnetic Interference, Compatibility, and induction.",
      difficulty: "Hard",
      tags: ["EMI/EMC", "Measurement", "Instrumentation"],
      sdg: "SDG9: Industry, Innovation and Infrastructure",
      fullDescription:
        "The objective is to design and develop portable instruments capable of accurately measuring Electromagnetic Interference (EMI), Electromagnetic Compatibility (EMC), and electromagnetic induction in various environments. These instruments should be compact, lightweight, and user-friendly, allowing for easy field deployment and on-site testing. The system should support real-time data acquisition and analysis, providing precise measurements that help ensure compliance with international EMI/EMC standards. Such instruments are crucial for industries involved in electronics, telecommunications, defense, automotive, and healthcare, where controlling electromagnetic emissions and ensuring device compatibility are critical. The solution should enhance the ability to detect and diagnose potential electromagnetic issues, reduce system downtime, and support preventive maintenance. Additionally, integrating features like wireless data transfer, cloud storage, and intuitive interfaces will enable efficient data management and remote monitoring.",
    },
  ]
    ...
    <div className="min-h-screen bg-black text-white">
      ...
      <div className="container mx-auto px-4 py-20">
        <div className="mb-8">
          ...
          >
            Explore electronics challenges that focus on developing innovative electronic systems and components. These
            problem statements aim to create solutions for various applications across industries.
          </motion.p>
        </div>
